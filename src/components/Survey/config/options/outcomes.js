export default {
  ...
  outcome2: {
    ...
    body:
      'You have symptoms commonly seen in COVID-19 and a possible contact and/or travel history. Please quarantine yourself until such time as testing can be arranged. Please note, this is not a diagnosis.',
    severity: 'severe',
  },
  outcome3: {
  ...
  outcome7: {
    ...
    testStatus: 'No. Its likely you will be turned away if you attempt to be tested.',
    body:
      'You have symptoms commonly seen in COVID-19 but no obvious contact with a positive patient. Please remain calm. Your symptoms are most likely due to another cause such as seasonal influenza. Complete our survey daily to keep track of your symptoms. You should seek medical care if your symptoms worsen. Please note, this is not a diagnosis.',
    severity: 'warn',
  },
};
